...
class RawEvent(collections.abc.MutableMapping):
    ...
    ```python
    {'attributes': [
        {'key': 'recipient', 'value': 'thor1uvu52rxwqj5ndmm59y6atvx33mru9xrz6sqekr'},
        {'key': 'sender', 'value': 'thos1zaavvzxez0elundtn32qnk9lkm8kmcsz44g7xl'},
        {'key': 'amount', 'value': '7uthor,70unusd'}],
    'type': 'transfer'}
    ```
    """
