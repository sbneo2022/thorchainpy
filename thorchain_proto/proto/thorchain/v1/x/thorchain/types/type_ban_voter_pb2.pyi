...
class BanVoter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["block_height", b"block_height", "node_address", b"node_address", "signers", b"signers"]) -> None: ...

global___BanVoter = BanVoter
