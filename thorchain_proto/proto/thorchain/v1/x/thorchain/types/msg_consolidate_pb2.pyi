...
class MsgConsolidate(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["observed_tx", b"observed_tx", "signer", b"signer"]) -> None: ...

global___MsgConsolidate = MsgConsolidate
